...
$meta['formposition'] = array('multichoice', '_choices' => array('top', 'bottom', 'none'));
$meta['newentrytitle'] = array('string');
$meta['dateprefix']   = array('string');
$meta['sortkey']      = array('multichoice', '_choices' => array('cdate', 'mdate', 'pagename', 'id', 'title'));
...
$meta['navigationlink'] = array('onoff');
