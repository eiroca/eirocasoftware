...
public class frMain_AboutBox extends Dialog implements ActionListener {
  ...
  String comments = "Programma simulazione centralini";

  // BevelPanel bevelPanel1 = new BevelPanel();

  public frMain_AboutBox(final Frame parent) {
    super(parent);
  ...
  private void jbInit() throws Exception {
    ...
    // panel1.add(bevelPanel1, BorderLayout.WEST);
